OC.L10N.register(
	"shiftsnext",
	{
		...
		"You cannot filter for a calendar date and week date at the same time.": "Du kannst nicht gleichzeitig auf ein Kalender-Datum und Wochen-Datum filtern.",
		"You do not have permissions to create shifts for group %1$s.": "Du hast keine Berechtigung, um Schichten für Gruppe %1$s zu erstellen.",
		"User %1$s is not a member of group %2$s.": "Benutzer:in %1$s ist kein Mitglied der Gruppe %2$s.",
		"You cannot create shifts from inactive shift type %1$s.": "Du kannst keine Schichten aus dem inaktiven Schicht-Typ %1$s erstellen.",
		"User %1$s is absent during the shift period (%2$s).": "Benutzer:in %1$s ist abwesend während des Schicht-Zeitraums (%2$s).",
		"You do not have permissions to update shifts for group %1$s.": "Du hast keine Berechtigung, um Schichten für Gruppe %1$s zu aktualisieren.",
		...
		"You do not have permissions to delete shifts for group %1$s.": "Du hast keine Berechtigung, um Schichten für Gruppe %1$s zu löschen.",
		"You can either exchange shifts or transfer a shift to another user, but not both.": "Du kannst entweder Schichten tauschen oder transferieren, jedoch nicht beides.",
		"Specify a second shift or a user to transfer the shift to.": "Spezifiziere eine zweite Schicht oder eine:n Benutzer:in zum Transferieren.",
		"You do not have permissions to create shift exchanges for all specified shifts.": "Du hast keine Berechtigung, um Schicht-Tausche für alle angegebenen Schichten zu erstellen.",
		"Exchanging shifts with yourself is not possible.": "Schichten mit dir selbst zu tauschen, ist nicht möglich.",
		...
		"You cannot update the participant and admin approval at the same time.": "Du kannst nicht gleichzeitig die Teilnehmer- und Admin-Genehmigung aktualisieren.",
		"You do not have permissions to update this shift exchange.": "Du hast keine Berechtigung, um diesen Schicht-Tausch zu aktualisieren.",
		...
		"%1$s assigned %2$s %3$s (%4$s) to you.": "%1$s hat dir %2$s %3$s (%4$s) zugewiesen.",
		"Shift moved": "Schicht verschoben",
		"%1$s moved %2$s %3$s (%4$s) from you to %5$s.": "%1$s hat %2$s %3$s (%4$s) von dir zu %5$s verschoben.",
