OC.L10N.register(
	"shiftsnext",
	{
		...
		"You need to have write access for calendar %1$s in order to choose it for synchronization.": "Du benötigst Schreibzugriff auf den Kalender %1$s, um ihn für die Synchronisierung auszuwählen.",
